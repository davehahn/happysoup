({
  doInit: function( component )
  {
    ...
    if( scope === 'dealer' || scope === 'supplier' )
      component.set('v.accountIcon', 'standard:account');
    else
       component.set('v.accountIcon', 'standard:person_account');
  },
  ...
  handleCreateAccount: function( component, event )
  {
    ...
    if( scope === 'new' )
      component.set('v.isCreatingNew', true);
    if( scope === 'close' )
      component.set('v.isCreatingNew', false);
  },
