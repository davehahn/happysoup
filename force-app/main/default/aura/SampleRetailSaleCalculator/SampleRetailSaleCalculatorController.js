    ...
    .then(
      $A.getCallback( function( result ) {
        if( result != null )
        {
          ...
          if( result.legendVolumeDiscount != null )
            component.set('v.mercDiscount', result.legendVolumeDiscount / 100 );
          if( result.legendCoopDiscount != null )
            component.set('v.coopDiscount', result.legendCoopDiscount / 100 );
          if( result.legendVolumeDiscount != null )
            component.set('v.volumeDiscount', result.legendVolumeDiscount / 100 );
        }
      }),
