({
    ...
    return new Promise(
      function(resolve, reject) {
        var self = this,
            options = [],
            values = [],
            action = component.get('c.getDealerAccounts'), la;
    ...
    return new Promise(
      function(resolve, reject) {
        var self = this,
            ...
            action = component.get('c.createNewPromotion'), la;
        action.setParams({
          promotion: promotion,
  ...
  getProducts : function(component) {
    return new Promise(
      function(resolve, reject) {
        var self = this,
            options = [],
            action = component.get('c.getProducts'), la;
        la = new LightningApex( this, action );
        la.fire()
        .then(
          $A.getCallback(
  ...
  getDetailedProducts : function(component) {
    return new Promise(
      function(resolve, reject) {
        ...
        promotion = component.get('v.promotion'),
        action = component.get('c.getDetailedProducts'), la;
        action.setParams({
          "prodIds" : prodIds,
          "promotion" : promotion
        });
    ...
    return new Promise(
      function(resolve, reject) {
        var self = this,
            ...
            action = component.get('c.savePromoAndItems'), la;
        action.setParams({
          "promotion" : promotion,
  ...
  getPromoDocumentationRequirementOptions : function(component) {
    return new Promise(
      function(resolve, reject) {
        var self = this,
            action = component.get('c.getPromoDocumentationRequirementOptions'), la;
        la = new LightningApex( this, action );
        la.fire()
        .then(
          $A.getCallback(
