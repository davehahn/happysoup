({
	...
	retrieveTransfers: function (component, event) {
        ...
        self.runAction(component, "c.retrieveTransfersByERP", {
            ...
            {
	            var listTns = [];
	            if(results.listTnsf != null)
	                listTns = JSON.parse(results.listTnsf);
	...
	checkIdType: function (component, event) {
        var self = this;
		//self.toggleSpinner(component, true);
        self.runAction(component, "c.checkId", {
	...
	createInvoice: function (component, idTnsf) {
        var self = this;
		self.toggleSpinner(component, true);
        self.runAction(component, "c.createTransferInvoice", {
            idERP: component.get("v.recordId"),
            idTnsf:idTnsf
        }, function(response) {
            self.toggleSpinner(component, false);
