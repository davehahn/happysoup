...
export default class CommunitySharedLeadForm extends NavigationMixin(LightningElement) {
  ...
  formatLeadObject() {
    ...
    const data = {
      FirstName: this.template.querySelector('[data-id="FirstName"]')
        ? this.template.querySelector('[data-id="FirstName"]').value
        : "",
      LastName: this.template.querySelector('[data-id="LastName"]')
        ? this.template.querySelector('[data-id="LastName"]').value
        : "",
      Street: this.template.querySelector('[data-id="Street"]')
        ? this.template.querySelector('[data-id="Street"]').value
        : "",
      City: this.template.querySelector('[data-id="City"]')
        ? this.template.querySelector('[data-id="City"]').value
        : "",
      State: this.template.querySelector('[data-id="Province"]')
        ? this.template.querySelector('[data-id="Province"]').value
        : "",
      Country: "Canada",
      PostalCode: this.template.querySelector('[data-id="PostalCode"]')
        ? this.template.querySelector('[data-id="PostalCode"]').value
        : "",
      Email: this.template.querySelector('[data-id="Email"]')
        ? this.template.querySelector('[data-id="Email"]').value
        : "",
      Phone: this.template.querySelector('[data-id="Phone"]')
        ? this.template.querySelector('[data-id="Phone"]').value
        : "",
      Description: this.formName + " | Serial Number: " + this.serialNumber,
      hubspot_plan_to_purchase__c: this.template.querySelector('[data-id="PurchaseByDate"]')
        ? this.template.querySelector('[data-id="PurchaseByDate"]').value
        : "",
      hubspot_Boat_Type__c: this.template.querySelector('[data-id="BoatType"]')
        ? this.template.querySelector('[data-id="BoatType"]').value
        : "",
      BoatModel__c: this.boatModelId
        ? this.boatModelId
        : this.template.querySelector('[data-id="BoatModel"]')
        ? this.template.querySelector('[data-id="BoatModel"]').value
        : "",
      hubspot_subscribe_legend_newsletter__c: this.template.querySelector('[data-id="Newsletter"]')
        ? this.template.querySelector('[data-id="Newsletter"]').checked
          ? "Yes"
          : "No"
        : "No",
      Preferred_Language__c: renderEN ? "English" : "French",
      Marketing_Cloud_Notes__c: this.template.querySelector('[data-id="Notes"]')
        ? this.template.querySelector('[data-id="Notes"]').value
        : "",
  ...
  formatLeadHistoryObject() {
    const data = {
      First_Name__c: this.template.querySelector('[data-id="FirstName"]')
        ? this.template.querySelector('[data-id="FirstName"]').value
        : "",
      Last_Name__c: this.template.querySelector('[data-id="LastName"]')
        ? this.template.querySelector('[data-id="LastName"]').value
        : "",
      Address__c: this.template.querySelector('[data-id="Street"]')
        ? this.template.querySelector('[data-id="Street"]').value
        : "",
      City__c: this.template.querySelector('[data-id="City"]')
        ? this.template.querySelector('[data-id="City"]').value
        : "",
      Province__c: this.template.querySelector('[data-id="Province"]')
        ? this.template.querySelector('[data-id="Province"]').value
        : "",
      Postal_Code__c: this.template.querySelector('[data-id="PostalCode"]')
        ? this.template.querySelector('[data-id="PostalCode"]').value
        : "",
      Email__c: this.template.querySelector('[data-id="Email"]')
        ? this.template.querySelector('[data-id="Email"]').value
        : "",
      Phone_Number__c: this.template.querySelector('[data-id="Phone"]')
        ? this.template.querySelector('[data-id="Phone"]').value
        : "",
      Description__c: this.formName,
      Purchase_By_Date__c: this.template.querySelector('[data-id="PurchaseByDate"]')
        ? this.template.querySelector('[data-id="PurchaseByDate"]').value
        : "",
      Boat_Type__c: this.boatType,
      Boat_Series__c: this.boatSeries,
      Boat_Model__c: this.boatModelId
        ? this.boatModelId
        : this.template.querySelector('[data-id="BoatModel"]')
        ? this.template.querySelector('[data-id="BoatModel"]').value
        : "",
      Boat_Name__c: this.boatName,
      Subscribe_to_Newsletter__c: this.template.querySelector('[data-id="Newsletter"]')
        ? this.template.querySelector('[data-id="Newsletter"]').checked
          ? "Yes"
          : "No"
        : "No",
      Preferred_Language__c: renderEN ? "English" : "French",
      Notes__c: this.template.querySelector('[data-id="Notes"]')
        ? this.template.querySelector('[data-id="Notes"]').value
        : "",
  ...
  get purchaseByDateOptions() {
    return [
      ...
      {
        label: "Not considering the purchase of a boat at this time",
        value: "Not considering the purchase of a boat at this time"
      }
    ];
  }
  get purchaseByDateOptionsFR() {
    return [
      ...
      {
        label: "Ne considère pas l'achat d'un nouveau bateau en ce moment",
        value: "Not considering the purchase of a boat at this time"
      }
    ];
  }
