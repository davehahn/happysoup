      ...
      fetchStaffList({ location: parseLocationName(this.locationName), department: this.department })
        .then((result) => {
          ...
          let newData = result.map((item) => ({
            ...
            StartYear: "2019",
            Story:
              "Quisque dapibus Leo ut mauris ultricies consectetur sit amet non leo. Pellentesque quis velit elit. Donec consectetur sem vitae lorem ultrices, eu fermentum augue fermentum. Duis non porttitor metus. Cras vel velit enim. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.",
            LandscapeImg:
              'background-image: url("https://mk0inventorylegv1t7j.kinstacdn.com/wp-content/uploads/2020/05/LegendLandscape-12.jpg")'
          }));
          this.users = newData;
