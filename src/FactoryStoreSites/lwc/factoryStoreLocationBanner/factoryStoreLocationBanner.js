      ...
      fetchCommunityDetails({ communityId: Id })
        .then((result) => {
          ...
          this.backgroundReference =
            'background-image: url("' + result.siteUrl + "/cms/delivery/media/" + this.backgroundImage + '")';
          console.log("allTeasers 1: ", this.allTeasers);
          if (this.teaserOneHeading) {
            const backgroundRef =
              'background-image: url("' + result.siteUrl + "/cms/delivery/media/" + this.teaserOneBackground + '")';
          ...
          if (this.teaserTwoHeading) {
            const backgroundRef =
              'background-image: url("' + result.siteUrl + "/cms/delivery/media/" + this.teaserTwoBackground + '")';
          ...
          if (this.teaserThreeHeading) {
            const backgroundRef =
              'background-image: url("' + result.siteUrl + "/cms/delivery/media/" + this.teaserThreeBackground + '")';
          ...
          if (this.moreInfoBackground) {
            const backgroundRef =
              'background-image: url("' + result.siteUrl + "/cms/delivery/media/" + this.moreInfoBackground + '")';
