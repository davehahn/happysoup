({
  doInit: function (component, event, helper) {
    ...
    helper.runAction(
      component,
      "c.retrieveERPInsuranceDocuments",
      {
  ...
  deleteDoc: function (component, event, helper) {
    ...
    if (idDoc != component.get("v.selectedDocId")) return false;
    helper.confirmDelete(component).then(
