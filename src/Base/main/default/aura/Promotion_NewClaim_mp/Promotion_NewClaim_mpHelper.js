({
  getProducts : function(component) {
    var action  = component.get('c.getProducts'), la,
        options = [];
  ...
  getAvailablePromotionsByProduct : function(component) {
    var action    = component.get('c.getAvailablePromotionsByProduct'), la,
  ...
  getPromotion : function(component) {
    var action      = component.get('c.getPromotionViaItem'), la,
  ...
  claimPromoWithoutSerno : function(component) {
    var action      = component.get('c.claimPromoWithoutSerno'), la,
        promoItemId = component.get('v.promoItemId'),
