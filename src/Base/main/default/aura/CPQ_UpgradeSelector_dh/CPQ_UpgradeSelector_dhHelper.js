({
  setStandardProductId: function (component) {
    ...
    if (upgradeType.toLowerCase() == "motor") component.set("v.standardProductId", cpq.theBoat.standardMotorId);
    if (upgradeType.toLowerCase() == "trailer") component.set("v.standardProductId", cpq.theBoat.standardTrailerId);
  ...
  removeSelectedOptions: function (component) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (selectedOptsIds.length > 0) {
        ...
        // });
        cpq.selectedOptions
          .reduce(function (list, opt, index) {
