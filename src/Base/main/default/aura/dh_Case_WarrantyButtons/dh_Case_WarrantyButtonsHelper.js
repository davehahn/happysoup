({
  ...
  {
    var action = component.get('c.fetchCase'), la;
  ...
  {
    var action = component.get('c.fetchAllSuppliers'), la;
    la = new LightningApex( this, action );
    return la.fire();
  },
  ...
  doStepOne: function( component )
  {
    ...
    self.createRecoverableERP( component )
    .then(
  ...
  doStepTwo: function( component )
  {
    ...
    $A.util.toggleClass(spinner, 'slds-hide');
    self.toggleRecoverableModal( component );
    self.createMaterials( component )
    .then(
  ...
  {
    var action = component.get('c.createWarrantyRecoverableERP'), la;
    action.setParams({
  ...
  deleteRecoverableERP: function( component )
  {
    ...
    if( recoverableErpId == null || recoverableErpId.length === 0 )
      return new Promise(
        $A.getCallback( function( resolve ){ resolve(); })
      );
