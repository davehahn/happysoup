({
  ...
  openClaimDialog: function (component, event, helper) {
    ...
    helper.getPromoItems(component, event).then(function (result) {
  ...
  enableSaveBtn: function (component, event, helper) {
    ...
    if (selectValue != "select") component.set("v.saveBtnDisabled", false);
    else component.set("v.saveBtnDisabled", true);
  },

  saveClaim: function (component, event, helper) {
    $A.util.addClass(component.find("newClaimForm"), "slds-hide");
    $A.util.removeClass(component.find("spinner"), "slds-hide");
    helper.createPromoClaim(component, event).then(function (result) {
