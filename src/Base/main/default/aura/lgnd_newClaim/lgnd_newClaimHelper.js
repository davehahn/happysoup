({
  doStep: function (component, event) {
    ...
    return new Promise(function (resolve, reject) {
      if (step == 1) {
        ...
        self.doStepOne(component, event).then(function () {
          component.set("v.disableNextButton", false);
          resolve();
        });
      } else if (step == 2) {
        // component.set('v.disableNextButton', true);
        self.doStepTwo(component, event).then(function () {
          component.set("v.disableNextButton", false);
          resolve();
        });
      } else if (step == 3) {
        component.set("v.disableNextButton", false);
        self.doStepThree(component, event).then(function () {
          resolve();
        });
      } else if (step == 4) {
        if (!initialized) {
        ...
        self.doStepFour(component, event).then(function () {
          resolve();
        });
      } else if (step == 5) {
        component.set("v.disableNextButton", true);
        self.doStepFive(component, event).then(function () {
          component.set("v.disableNextButton", false);
          resolve();
        });
      } else {
    ...
    return new Promise(function (resolve, reject) {
      if (!problem || !type || !correction) {
        ...
        if (hours > 0 && !component.get("v.labourAdded")) {
          self
            .callAction(component, "getProduct", {
              id: productId
            })
            .then(
  ...
  doStepFour: function (component, event) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      self.saveProblem(component, event).then(
        $A.getCallback(function () {
          ...
          $A.util.addClass(component.find("spinner"), "slds-hide");
          self.createUploader(component).then(
            $A.getCallback(function () {
              resolve();
            }),
            $A.getCallback(function () {
  ...
  saveProblem: function (component, event) {
    ...
    return new Promise(function (resolve, reject) {
      self.createClaim(component).then(
        $A.getCallback(function () {
          resolve();
        }),
  ...
  updateClaims: function (component, event) {
    ...
    return new Promise(function (resolve, reject) {
      for (var claim in claims) {
        self.updateClaim(component, claim).then(
          $A.getCallback(function () {
            i++;
            if (i == claims.length) {
              resolve();
  ...
  deletePart: function (component, event) {
    ...
    if (part.Id != undefined || part.Id != null) {
      ...
      return new Promise(function (resolve, reject) {
        self
          .callAction(component, "deletePartById", {
            idPart: part.Id
          })
          .then(
        ...
        if (parts[i].Product__c == component.get("v.productId")) {
          ...
          if (hours > 0) {
            if (parts[i].Id != undefined) {
              return new Promise(function (resolve, reject) {
                self
                  .callAction(component, "updatePartById", {
                    idPart: parts[i].Id,
                    qty: hours
                  })
                  .then(
  ...
  getParts: function (component) {
    ...
    return new Promise(function (resolve, reject) {
      self
        .callAction(component, "getPartByCaseId", {
  ...
  validateProblem: function (component) {
    ...
    if (component.get("v.showSublet")) {
      ...
      if (subletPriceComponent.length > 1) subletPriceComponent = subletPriceComponent[subletPriceComponent.length - 1];
  ...
  removeClaims: function (component) {
    ...
    return new Promise(function (resolve, reject) {
      self.callAction(component, "deleteClaims", { claimIds: claimIds }).then(
        $A.getCallback(function () {
          resolve();
        })
      );
  ...
  getUnitPrice: function (component, productId) {
    ...
    return new Promise(function (resolve, reject) {
      self
        .callAction(component, "getUnitPrice", {
          productId: productId
        })
        .then(
