({
  doInit: function (component, event, helper) {
    ...
    new LightningApex(helper, action)
      .fire()
      .then(
  ...
  next: function (component, event, helper) {
    ...
    helper.doStep(component, event).then(function () {
  ...
  back: function (component, event, helper) {
    ...
    new Promise(function (resolve, reject) {
      if (onStep == 5) {
        ...
        helper.getParts(component).then(
  ...
  cancel: function (component, event, helper) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      $A.getCallback(function () {
        ...
        if (claims.length < 1) {
          helper.removeClaims(component).then(
            $A.getCallback(function () {
              onStep = 1;
              component.set("v.onStep", onStep);
          ...
          helper.removeClaim(component).then(
            $A.getCallback(function () {
              onStep = 6;
              component.set("v.onStep", onStep);
              $A.util.addClass(component.find("spinner"), "slds-hide");
  ...
  submit: function (component, event, helper) {
    ...
    helper.updateClaims(component, event).then(
      $A.getCallback(function () {
  ...
  addPart: function (component, event, helper) {
    ...
    helper.getProduct(component, partProductId).then(
      $A.getCallback(function (product) {
        if (product) {
          helper.getUnitPrice(component, product.Id).then(
