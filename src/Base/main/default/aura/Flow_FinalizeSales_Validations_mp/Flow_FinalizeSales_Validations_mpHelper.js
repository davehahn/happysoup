({
  ...
  checkIfReady: function (component, event) {
    ...
    self
      .getJournalEntrySettings(component)
      .then(
        $A.getCallback(function (result) {
      ...
      .then(
        $A.getCallback(function (result) {
          return new Promise(function (resolve, reject) {
            self
              .getTradeInRecordType(component)
              .then(
                $A.getCallback(function (result) {
  ...
  getJournalEntrySettings: function (component) {
    ...
    var self = this,
      action = component.get("c.getJournalEntrySettings"),
      la;
    return new Promise(function (resolve, reject) {
      la = new LightningApex(this, action);
      la.fire().then(
  ...
  getSalesperson: function (component) {
    ...
    var self = this,
      action = component.get("c.getSalesperson"),
      la,
  ...
  getCustomer: function (component) {
    ...
    var self = this,
      action = component.get("c.getCustomer"),
      la,
      erp = component.get("v.erp");
    return new Promise(function (resolve, reject) {
      action.setParams({
  ...
  getReceipts: function (component) {
    ...
    var self = this,
      action = component.get("c.getReceipts"),
      la,
  ...
  getBillings: function (component) {
    ...
    var self = this,
      action = component.get("c.getBillings"),
      la,
      customer = component.get("v.Customer"),
      erp = component.get("v.erp"),
  ...
  getLocation: function (component) {
    ...
    var self = this,
      action = component.get("c.getLocation"),
      la,
      erp = component.get("v.erp");
    return new Promise(function (resolve, reject) {
      action.setParams({
      ...
      la.fire().then(
        $A.getCallback(function (result) {
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            if (
              result[i].AcctSeedERP__Quantity_Allocated__c < result[i].AcctSeedERP__Quantity_Per_Unit__c &&
              !result[i].No_WIP__c
            ) {
  ...
  getMaximumMotor: function (component) {
    ...
    var self = this,
      action = component.get("c.getMaximumMotor"),
      la,
      erp = component.get("v.erp"),
  ...
  getTradeIns: function (component) {
    ...
    var self = this,
      action = component.get("c.getTradeIns"),
      la,
      erp = component.get("v.erp");
    return new Promise(function (resolve, reject) {
      action.setParams({
  ...
  getTradeInRecordType: function (component) {
    ...
    var self = this,
      action = component.get("c.getTradeInRecordType"),
      la;
    return new Promise(function (resolve, reject) {
      la = new LightningApex(this, action);
      la.fire().then(
  ...
  getTradeInERP: function (component) {
    ...
    var self = this,
      ...
      action = component.get("c.getTradeInERP"),
      la;
    return new Promise(function (resolve, reject) {
  ...
  getInboundInventory: function (component) {
    ...
    var self = this,
      ...
      action = component.get("c.getInboundInventory"),
      la;
    return new Promise(function (resolve, reject) {
      if (tradein != null) {
  ...
  setTradeInToComplete: function (component) {
    ...
    var self = this,
      tradein = component.get("v.TradeInERP"),
      action = component.get("c.setTradeInToComplete"),
      la;
    return new Promise(function (resolve, reject) {
      action.setParams({
        erpId: tradein.Id
  ...
  getInsuranceItems: function (component) {
    ...
    var self = this,
      ...
      action = component.get("c.getInsuranceItems"),
      la;
    return new Promise(function (resolve, reject) {
      action.setParams({
        erpId: erp.Id
        ...
        $A.getCallback(function (result) {
          ...
          for (var i = 0; i < result.length; i++) {
            if (result[i].Product_Record_Type__c == "Insurance") {
              ...
              f_5200 += 0.0; //result[i].GMBLASERP__Total_Price__c / 2;
            }
          }
  ...
  getCommissionRecords: function (component) {
    ...
    var self = this,
      ...
      f_2300c,
      f_2300d,
      action = component.get("c.getCommissionRecords"),
      la,
      erp = component.get("v.erp"),
      isBalanced = false;
    return new Promise(function (resolve, reject) {
  ...
  getPartnerPricebook: function (component) {
    ...
    var self = this,
      ...
      action = component.get("c.getPartnerPricebook"),
      la;
    return new Promise(function (resolve, reject) {
      action.setParams({
        pbId: pbId
  ...
  getErpTasks: function (component) {
    ...
    var self = this,
      erp = component.get("v.erp"),
      action = component.get("c.getErpTasks"),
      la;
    return new Promise(function (resolve, reject) {
      action.setParams({
        erpId: erp.Id
  ...
  getNestedItems: function (component) {
    ...
    var self = this,
      ...
      f_5000a = component.get("v.f_5000a"),
      action = component.get("c.getNestedItems"),
      la;
          ...
          result.forEach(function (item) {
            ...
            if (item.entry != null) {
              if (item.serialNumber.Product_Record_Type__c == "Motor") {
                ...
                console.log(
                  "unitPrice(" +
                    item.serialNumber.GMBLASERP__Product__r.AcctSeed__Unit_Cost__c +
                    ") x Line1125__c(" +
                    JESettings.Line1125__c +
                    ")"
                );
                f_1125 +=
                  item.serialNumber.GMBLASERP__Product__r.AcctSeed__Unit_Cost__c * (JESettings.Line1125__c / 100);
  ...
  getBoat: function (component) {
    ...
    var self = this,
      ...
      pb = component.get("v.PartnerPricebook"),
      f_4000 = component.get("v.f_4000"),
      action = component.get("c.getBoat"),
      la;
    return new Promise(function (resolve, reject) {
      action.setParams({
