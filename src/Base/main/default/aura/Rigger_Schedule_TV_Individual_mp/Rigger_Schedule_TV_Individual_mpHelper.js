  ...
  getJobs: function (component, riggerId, action) {
    ...
    self.actionHandler(action, true).then(function (wrappedJobs) {
      ...
      for (j of wrappedJobs) {
        ...
        if (j.job.Placeholder__c) j.job.class = "dragItem card-collapsed placeholder";
        else if (j.job.ERP_Order__r.Job_Status__c == "In Progress") j.job.class = "dragItem card-collapsed inProgress";
        else if (
          j.job.ERP_Order__r.Job_Status__c == "Parts Required" ||
          ...
          j.job.ERP_Order__r.Job_Status__c == "Sublet" ||
        ...
        else j.job.class = "dragItem card-collapsed";
        ...
        if (j.job.ERP_Order__c !== undefined) {
          if (
            j.job.ERP_Order__r.RecordType.Name == "Retail Boat Sale" ||
