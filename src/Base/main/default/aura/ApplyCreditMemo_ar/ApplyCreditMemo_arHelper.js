({
    ...
    retrieveBillingData: function(component, event, helper) {
        ...
        this.runAction(component, "c.retrieveInvoices", {
    ...
    sendBCMData: function(component, listData) {
    	helper = this;
        helper.toggleSpinner(component, true);
        this.runAction(component, "c.createBCM", {
            ...
            if (state != "SUCCESS") {
                ...
                if (errors) {
                    if (errors[0] && errors[0].message) {
                        ...
                        helper.showNotice(component, "Error In BCM", "error", "There was an error applying credit memo. Please try again.");
                    }
                    helper.toggleSpinner(component, false);
                    return;
                }
