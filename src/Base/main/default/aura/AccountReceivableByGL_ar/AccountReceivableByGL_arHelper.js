  ...
  openModal: function (component, event, helper) {
    ...
    helper.runAction(
      ...
      function (response) {
        ...
        component.set(
          "v.listTitle",
          dataType == "arcontrol" ? "AR Control GL Transactions" : "Unapplied GL Transactions"
        );
        var results = response.getReturnValue();
        results = JSON.parse(results);
