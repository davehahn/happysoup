({
  ...
  validateDetails: function (component) {
    ...
    if (validSerno && validModel && validYear && validDescription) isValid = true;
  ...
  validateSerno: function (component) {
    ...
    if (sernoName != null && sernoName != "") isValid = true;
    else component.set("v.error", error.concat("Invalid serial number. "));
  ...
  validateModel: function (component) {
    ...
    if (model != null && model != "") isValid = true;
    else component.set("v.error", error.concat("Invalid product model. "));
  ...
  validateDescription: function (component) {
    ...
    if (description != null && description != "") isValid = true;
    else component.set("v.error", error.concat("Please provide a part description."));
