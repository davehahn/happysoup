({
  ...
  checkForPartsRequiringOrdering: function (component) {
    var action = component.get("c.checkForParts"),
      la;
    action.setParams({
  ...
  initNewPO: function (component) {
    var action = component.get("c.fetchInitialPoData"),
      la;
    action.setParams({
      recordId: component.get("v.recordId")
    });
  ...
  createPOlinesAndUpdateCase: function (component, poId, setDefaultVendor) {
    var action = component.get("c.createPOlinesAndUdateCase"),
      la;
    action.setParams({
