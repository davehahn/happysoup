({
	 saleItemFromSelectedOption: function( component, event, helper )
  {
    ...
    if( option.selectedSubOptions !== undefined &&
  ...
  doCalculation: function( component, event, helper )
  {
    var self = this,
        ...
        params = event.getParam("arguments"),
        cpq = params.cpq,
        deposit = isNaN( cpq.deposit ) ||
                  cpq.deposit === null ||
                  cpq.deposit === undefined ||
                  cpq.deposit.length == 0 ? 0 : parseFloat( cpq.deposit ),
        totals = {
          subTotal: 0,
          savingsTotal: 0,
          taxableTotal: 0,
        ...
        {
          if( Object.keys( cpq ).indexOf(theProduct) >= 0 &&
              cpq[theProduct] != null )
          {
            var cost = theProduct === 'theBoat' ?
              cpq[theProduct].retailPrice :
              cpq[theProduct].retailUpgradeCost;
    ...
    totals.preTaxTotal = totals.subTotal +
                         totals.savingsTotal -
                         deposit -
