  ...
  drop: function (component, event, helper) {
    ...
    if (event.target.parentElement.classList.contains("placeholder")) {
      ...
      event.target
        ...
        .insertBefore(document.getElementById(data), event.target.closest(".dragItem").closest("span"));
    } else {
      event.target
    ...
    helper
      .assignJob(component, event, event.target.closest(".dropContainer").id)
      .then(
      ...
      .then(
        $A.getCallback(function () {
          if (event.target.classList.contains("overlay")) {
            event.target.closest(".jobsContainer").removeChild(document.getElementById(data));
          } else {
