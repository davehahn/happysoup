({
  doInit: function (component, event, helper) {
    helper.getDealerAccounts(component).then(function () {
      helper.getProducts(component).then(function () {
  ...
  goToStep2: function (component, event, helper) {
    ...
    helper.createNewPromotion(component).then(function () {
  ...
  goToStep3: function (component, event, helper) {
    $A.util.removeClass(component.find("spinner"), "slds-hide");
    helper.getDetailedProducts(component).then(function () {
  ...
  publish: function (component, event, helper) {
    helper.savePromoAndItems(component).then(function () {
