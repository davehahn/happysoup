({
  ...
  handleStageChange: function (params, component) {
    ...
    if (actionNumber === 1 && prevActionNumber === 0) component.find("orderBuildBoat--Cmp").doInit();
    ...
    if (actionNumber === 1 && prevActionNumber === 2) {
      ...
      else component.find("orderBuildBoat--Cmp").doInit();
    }
  },
  ...
  cancelOrder: function (component) {
    ...
    if (dealerOrder.Id === undefined || dealerOrder.Id === null) {
