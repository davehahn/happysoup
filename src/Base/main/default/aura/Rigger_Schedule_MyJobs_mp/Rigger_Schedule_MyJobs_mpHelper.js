  ...
  getMyJobs: function (component) {
    ...
    self.actionHandler(action, false).then(function (jobs) {
      ...
      for (job of jobs) {
        ...
        if (job.age > -1) job.class = "slds-box dragItem dueLater";
        else if (job.age == -1) job.class = "slds-box dragItem dueToday";
        else if (job.age < -1) job.class = "slds-box dragItem dueDateMissed";
        else job.class = "slds-box dragItem";
      }
