({
  ...
  handleStepBack: function (component) {
    ...
    if (stepIdx > 0) component.set("v.currentStep", steps[stepIdx - 1]);
  },
  ...
  handleStepNext: function (component) {
    ...
    if (stepIdx !== steps.length - 1) component.set("v.currentStep", steps[stepIdx + 1]);
  },
